...
def cnnModel(embeddingMatrix, embedding_dim, hidden_dim, name):
    ...
    """
    sequence = Input(shape=(140,), dtype='int32')

    embedded = Embedding(input_dim=embeddingMatrix.shape[0], output_dim=embedding_dim, input_length=140, weights=[embeddingMatrix],
                         trainable=False)(sequence)
    embedded = Dropout(0.25)(embedded)
    # convolutional layer
    convolution = Convolution1D(filters=hidden_dim,
